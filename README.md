## Config Server
[![Infra Deployment](https://github.com/DavidCamelo/config-server/actions/workflows/deploy.yml/badge.svg)](https://github.com/DavidCamelo/config-server/actions/workflows/deploy.yml)
